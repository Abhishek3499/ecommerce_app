...
/// Screen displayed during onboarding - final ready screen
/// Shows final call-to-action before entering the main app
class ReadyCardScreen extends StatelessWidget {
  final UserModel user;

  const ReadyCardScreen({super.key, required this.user});
